          ...
          columns: [
            ...
            //botones
            {
              render: function(data, type, row) {
                return (
                  "<div class='row ValAcc'><div class='col-xs-12 Val-UDP'><a href='#'style='color: #2980b9' onclick='editar(" +
                  row.id +
                  ")' data-toggle='modal' data-target='#nuevoU'> <i class='material-icons'>edit</i></a> <a href='#' style='color:  #c0392b ' onclick='borrar(" +
                  row.id +
                  ")' data-toggle='modal' data-target='#borrar'><i class='material-icons'>delete_forever</i></a> </div></div>"
                );
              }
            }
          ],
...
function editar(id) {
  $("#exampleModalLabel").text("Editar certificación");
  $.ajax({
